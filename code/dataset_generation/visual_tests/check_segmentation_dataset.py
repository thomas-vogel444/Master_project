...
plt.imshow(segmented_CT_scan.image[:,y_slice,:], cmap = cm.Greys_r)
a   = fig.add_subplot(2,3,5)
plt.imshow(segmented_CT_scan.labels[:,y_slice,:], cmap = cm.Greys_r)
a   = fig.add_subplot(2,3,3)
plt.imshow(segmented_CT_scan.image[x_slice,:,:], cmap = cm.Greys_r)
...
fig = plt.figure()
a   = fig.add_subplot(2,3,1)
plt.imshow(true_values_fixed_z, cmap = cm.Greys_r)
a   = fig.add_subplot(2,3,4)
plt.imshow(true_labels_fixed_z, cmap = cm.Greys_r)
a   = fig.add_subplot(2,3,2)
plt.imshow(true_values_fixed_y, cmap = cm.Greys_r)
a   = fig.add_subplot(2,3,5)
plt.imshow(true_labels_fixed_y, cmap = cm.Greys_r)
a   = fig.add_subplot(2,3,3)
plt.imshow(true_values_fixed_x, cmap = cm.Greys_r)
a   = fig.add_subplot(2,3,6)
