...
\noindent The results for 1 and 2 fully connected layer architecture are very similar with better sensitivity for the 1 connected layer. However the specificity for 3 connected layers decreases significantly bringing down its test dice coefficient. Figure whatever shows very similar masks for the 1 and 2 connected layers and larger errors for the third column. \\

\noindent We choose to have 1 fully connected layer for our final architecture.
