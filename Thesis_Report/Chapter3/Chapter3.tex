...
\begin{tabular}{cccccc}
\rowcolor[HTML]{C0C0C0} 
               \begin{tabular}[c]{@{}c@{}}Pooling \\ Function\end{tabular} & \begin{tabular}[c]{@{}c@{}}Dice \\ training set\end{tabular} & \begin{tabular}[c]{@{}c@{}}Dice \\ testing set\end{tabular} & Sensitivity & Specificity & \begin{tabular}[c]{@{}c@{}}Dice \\ test CT scan\end{tabular} \\ \hline
Max      & 0.956                                                        & 0.953                                                       & 0.923       & 0.967       & 0.966                                                        \\ 
Average  & 0.953                                                        & 0.95                                                        & 0.937       & 0.964       & 0.963                                                       
\end{tabular}
...
\rowcolor[HTML]{FFFFFF} 
0.05     & 0.979                                                        & 0.973                                                       & 0.916       & 0.916       & 0.979                                                        \\ 
\rowcolor[HTML]{FFFFFF} 
0.1      & 0.983                                                        & 0.976                                                       & 0.9         & 0.9         & 0.982                                                        \\
\rowcolor[HTML]{FFFFFF} 
0.5      & 0.985                                                        & 0.981                                                       & 0.83        & 0.83        & 0.985                                                       
\end{tabular}
